# СекцияCDATADOM.УдалитьДочерний

**↑** [Главная](_index.md) › [Объекты](_index__Объекты.md) › [Общие объекты](Общие_объекты.md) › [DOM](DOM-2.md) › [СекцияCDATADOM](СекцияCDATADOM_(DOMCDATASection).md) › [Методы](СекцияCDATADOM__Методы.md)
