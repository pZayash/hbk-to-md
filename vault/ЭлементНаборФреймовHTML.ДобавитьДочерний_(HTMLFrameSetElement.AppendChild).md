# ЭлементНаборФреймовHTML.ДобавитьДочерний

**↑** [Главная](_index.md) › [Объекты](_index__Объекты.md) › [Общие объекты](Общие_объекты.md) › [HTML](HTML.md) › [ЭлементНаборФреймовHTML](ЭлементНаборФреймовHTML_(HTMLFrameSetElement).md) › [Методы](ЭлементНаборФреймовHTML__Методы.md)
