...
[Visible (Visible)](Automation_сервер.Visible.md)  

Методы:

[Connect (Connect)](Automation_сервер.Connect.md)  
[NewObject (NewObject)](Automation_сервер.NewObject.md)  
[String (String)](Automation_сервер.String.md)  
...
- выполняется инициализация системы 1С:Предприятие методом [Connect](Automation_сервер.Connect.md) (для тонкого клиента существует возможность передать в строке соединения дополнительные параметры прокси сервера);
