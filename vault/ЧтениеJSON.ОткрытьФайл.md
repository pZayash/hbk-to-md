...
<!-- signature:start -->
`ОткрытьФайл`(`<ИмяФайла>`: `Строка`, `<Кодировка>`: `Строка` | [`КодировкаТекста`](КодировкаТекста.md))
<!-- signature:end -->
...
ОткрытьФайл(<ИмяФайла>, <Кодировка>)
...
|  |
| --- |
| ЧтениеJSON = Новый ЧтениеJSON; ЧтениеJSON.ОткрытьФайл("c:/docs/data.json"); |
