# ЭлементЛинияHTML.ДобавитьДочерний

**↑** [Главная](_index.md) › [Объекты](_index__Объекты.md) › [Общие объекты](Общие_объекты.md) › [HTML](HTML.md) › [ЭлементЛинияHTML](ЭлементЛинияHTML_(HTMLHRElement).md) › [Методы](ЭлементЛинияHTML__Методы.md)
