...
Вызвать переопределенный метод можно с помощью функции глобального контекста [ПродолжитьВызов()](Глобальный_контекст.ПродолжитьВызов_(Global_context.ProceedWithCall).md).
