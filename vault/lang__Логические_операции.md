...
Логическая операция сравнивает операнды и вырабатывает значение типа [Булево](lang__Булево_(Boolean).md): [Истина](lang__def_BooleanTrue.md) или [Ложь](lang__def_BooleanFalse.md). Существует два вида логических операций: операции сравнения и булевы операции. В операциях сравнения сравниваются два значения. Булевы операции выполняются над значениями типа [Булево](lang__Булево_(Boolean).md), реализуя булеву алгебру. Символы булевых операций могут комбинироваться, образуя составные операции.
