# ЧтениеFastInfoset.КодировкаXML
...
Если атрибут не указан или объявление не прочитано (отсутствует), то будет возвращена кодировка [UTF8](КодировкаТекста.UTF8_(TextEncoding.UTF8).md).
