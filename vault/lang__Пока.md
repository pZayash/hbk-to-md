...
**Описание:**Оператор цикла **Пока** предназначен для циклического повторения операторов, находящиеся внутри конструкции **Цикл – КонецЦикла**. Цикл выполняется, пока логическое выражение равно Истина. Условие выполнения цикла всегда проверяется вначале, перед выполнением цикла.
