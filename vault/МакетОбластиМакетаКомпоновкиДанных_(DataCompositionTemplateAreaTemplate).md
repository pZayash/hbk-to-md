...
[Макет (Template)](МакетОбластиМакетаКомпоновкиДанных.Макет_(DataCompositionTemplateAreaTemplate.Template).md)  
...
- [Свойства (1 страниц)](МакетОбластиМакетаКомпоновкиДанных__Свойства.md)
<!-- toc:end -->
